About aws-amicleaner-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aws-amicleaner-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8366&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aws-amicleaner-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aws-amicleaner` can be installed with `conda`:
...
```
mamba install aws-amicleaner
```

It is possible to list all of the versions of `aws-amicleaner` available on your platform with `conda`:
...
```
mamba search aws-amicleaner --channel conda-forge
```
...
mamba repoquery search aws-amicleaner --channel conda-forge

# List packages depending on `aws-amicleaner`:
mamba repoquery whoneeds aws-amicleaner --channel conda-forge

# List dependencies of `aws-amicleaner`:
mamba repoquery depends aws-amicleaner --channel conda-forge
```
